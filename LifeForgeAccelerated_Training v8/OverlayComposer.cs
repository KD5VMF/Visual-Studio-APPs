...
internal sealed class OverlayComposer
{
    ...
    public Bitmap Compose(int width, int height, World world, bool paused, bool showHelp, float simSpeed, float fps, bool fullscreen)
    {
        ...
        var metaLines = BuildMetaLines(g, bodyFont, controlInnerWidth,
            ...
            $"Prey {world.Preys.Count}   Pred {world.Predators.Count}   Save {world.TrainingSlotLabel}   Rebirths {world.RebirthCount}");
        ...
        DrawStatRow(g, bodyFont, soft, x, y + 133, 116, "Save slot", world.TrainingSlotLabel);
        ...
        if (showHelp)
        {
            ...
            var helpText = string.Join(Environment.NewLine,
                ...
                "• Training snapshots auto-save into the training folder as numbered Trained_Data-XX.json files and wrap after slot 1000.",
