...
- Added automatic training snapshot save/load using numbered `Trained_Data-XX.json` files in the app folder.
- Slots rotate from `Trained_Data-00.json` through `Trained_Data-1000.json`, then wrap back to `00`.
